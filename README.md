...
```sh
cargo install --git https://github.com/brickfrog/benkyou-yaro --tag v0.2.0
mkdir -p ~/.claude/skills/benkyou
curl -sfL https://raw.githubusercontent.com/brickfrog/benkyou-yaro/v0.2.0/skill/SKILL.md \
